        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?=base_url()?>keuangan-dashboard"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>

                    <li>
                        <a href="<?=base_url()?>keuangan-mingguan"><i class="fa fa-table fa-fw"></i> Laporan Mingguan</a>
                    </li>
                    <!--                    <li>-->
                    <!--                        <a href="#"><i class="fa fa-edit fa-fw"></i> Input Hasil Presentasi</a>-->
                    <!--                    </li>-->
                    <li>
                        <a href="<?=base_url()?>keuangan-bulanan"><i class="fa fa-edit fa-fw"></i> Laporan Bulanan</a>
                    </li>
                    <!--                    <li>-->

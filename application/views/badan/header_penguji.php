        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?=base_url()?>penguji-dashboard"><i class="fa fa-dashboard fa-fw"></i> Input Uji Petik</a>
                    </li>

                    <li>
                        <a href="<?=base_url()?>penguji-penawaran"><i class="fa fa-table fa-fw"></i> Kirim Penawaran</a>
                    </li>

                    <li>
                        <a href="<?=base_url()?>penguji-daftar_penawaran"><i class="fa fa-table fa-fw"></i> Daftar Penawaran</a>
                    </li>

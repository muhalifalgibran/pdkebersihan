...
<!--                        </div>-->
                    ...
                    <li>
                        <a href="<?=base_url()?>super-dashboard"><i class="fa fa-dashboard fa-fw"></i> Daftar Pegawai</a>
                    </li>

                    <li>
                        <a href="<?=base_url()?>super-regis"><i class="fa fa-table fa-fw"></i> Registrasi Pegawai</a>
                    </li>

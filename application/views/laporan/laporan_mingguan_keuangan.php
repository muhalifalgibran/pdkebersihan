            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php //echo form_open('kasie-dashboard') ?>
                        <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>bidangKeuangan/BidangKeuangan/mingguan/1">Minggu 1</a></button>
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>bidangKeuangan/BidangKeuangan/mingguan/2">Minggu 2</a></button>
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>bidangKeuangan/BidangKeuangan/mingguan/3">Minggu 3</a></button>
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>bidangKeuangan/BidangKeuangan/mingguan/4">Minggu 4</a></button>

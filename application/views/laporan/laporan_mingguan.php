        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>kasiePelsus/KasiePelsus/mingguan/1">Minggu 1</a></button>
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>kasiePelsus/KasiePelsus/mingguan/2">Minggu 2</a></button>
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>kasiePelsus/KasiePelsus/mingguan/3">Minggu 3</a></button>
                    <button type="submit" class="btn btn-secondary"><a href="<?php echo base_url() ?>kasiePelsus/KasiePelsus/mingguan/4">Minggu 4</a></button>

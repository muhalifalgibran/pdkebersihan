                    ...
                    <div class="panel-body">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="datssaTables-example">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <a href="<?php echo base_url()?>marketing/Marketing/update/sukses/<?php echo $pel->idPelanggan ?>"><button type="button" class="btn btn-success" >Pelanggan</button></a>
                                    <a href="<?php echo base_url()?>marketing/Marketing/update/kembali/<?php echo $pel->idPelanggan ?>"><button type="button" class="btn btn-danger">Batal</button></a>
